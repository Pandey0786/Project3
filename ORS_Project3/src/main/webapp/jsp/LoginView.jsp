...
.p1 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/BackG.jpg');
	background-size: 100%;
					...
					<div>
						...
						<div>
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text"><i
										class="fa fa-envelope grey-text" style="font-size: 1.5rem;"></i></span>
								</div>
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text"><i
										class="fa fa-lock grey-text" style="font-size: 1.5rem;"></i></span>
								</div>
							...
							<div class="text-center">
								<button class="btn btn-primary btn-sm" style="width: 8cm"
									name="operation" value="<%=LoginCtl.OP_SIGN_IN%>">
									<b>LOGIN</b>
								</button>
								<p>
									<a href="<%=ORSView.FORGOT_PASSWORD_CTL%>" class="text-muted">Forgot
										Password ?</a>
								</p>
							</div>
							</br> </br>
